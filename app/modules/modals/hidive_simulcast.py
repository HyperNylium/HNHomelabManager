...
class HidiveSimulcastModal(RequestModal):
    def __init__(self):
        ...
        self.url = discord.ui.TextInput(label="HiDive URL", required=True, max_length=400)
        ...
        super().__init__(title="HiDive simulcast request", fields=[self.name, self.lookup_url, self.url, self.notes])
